// receiver (receives messages from the message queue, reverses them and displays it on the console)
...
int main()
{
    ...
    while (running)
    {
	    ...
	    else
	    {
	        ...
	        reverseString(msg.messageContent);
